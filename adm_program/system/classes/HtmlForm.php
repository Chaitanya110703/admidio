...
class HtmlForm extends HtmlFormBasic
{
    ...
    public function addCaptcha($id, $class = '')
    {
        ...
        $onClickCode = 'document.getElementById(\'captcha\').src=\'' . ADMIDIO_URL . FOLDER_LIBS . '/securimage/securimage_show.php?\' + Math.random(); return false;';
        $this->addHtml('<img id="captcha" src="' . ADMIDIO_URL . FOLDER_LIBS . '/securimage/securimage_show.php" alt="CAPTCHA Image" />
